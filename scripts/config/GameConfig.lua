...
GameConfig.Level1 = {
    ...
    DuckPositions = {
        Vector3(3,  0, 7),    -- d1 左侧
        Vector3(5,  0, 4),    -- d2 木箱旁
        Vector3(10, 0, 8),    -- d3 中央
        Vector3(8,  0, 5.5),  -- d4 草丛附近
        Vector3(11, 0, 5),    -- d5 靠近目标区
        Vector3(13, 0, 10),   -- d6 右上角
        Vector3(8,  0, 10),   -- d7 中上方
        Vector3(12, 0, 3),    -- d8 右下方
    },
...
GameConfig.VARS = {
    ...
    DUCK_STATE  = StringHash("DuckState"),  -- "idle" / "alert" / "panic" / "settled"
}
